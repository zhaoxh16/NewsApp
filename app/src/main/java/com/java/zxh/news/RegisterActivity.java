    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                map.put("activity", "register");
                HashMap<String, String> registerInfoMap = new HashMap<String, String>();
                registerInfoMap.put("name",mEmail);
                registerInfoMap.put("password",mPassword);
                map.put("param", registerInfoMap);
